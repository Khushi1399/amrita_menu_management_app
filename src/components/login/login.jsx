...
const Login = () => {
  return (
    <>
      <section class="bg-blue-50 dark:bg-gray-300 backdrop-opacity-5">
        ...
        >
          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-stone-600 dark:border-stone-600">
